...
arr.forEach(function(addKeyPowerIndex) {
...
function nameLongerThan(arrofobj4,6){
  [
  { name: "alex" },
  { name: "mercer"},
  { name: "alice" },
...
const result = number.filter(number => number.length > 6);
...
function avgLength(arr1,"rahma") {
var avgLength = avgLength.Reduce()=>{
